...
//1
const huskyWeight = breeds.find(acc => acc.breed === 'Husky').averageWeight;
console.log(huskyWeight);

//2
const breedName = breeds.find(
  acc => acc.activities.includes('running') && acc.activities.includes('fetch')
).breed;
console.log(breedName);

//3
const allActivities = breeds.map(acc => acc.activities).flat();
